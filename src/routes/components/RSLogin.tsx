    ...
    <div class="col-lg-6 mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        <div class="input-group mb-3">
          <input type="password" class="form-control" ref={seedInput} placeholder="Seed" aria-label="Seed" aria-describedby="seed" />
        </div>
          <button type="submit" class="btn btn-primary px-4 gap-3">Login</button>
          <br />
          <Link href="/register/"><small class="text-white">Register</small></Link>
        </form>
      </div>
    </div>
  </div>
