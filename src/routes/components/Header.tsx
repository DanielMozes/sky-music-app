	...
	return (
		...
		>
			...
			>
				<Link
					href="/"
					class="d-flex align-items-center col-lg-4 mb-2 mb-lg-0 text-decoration-none navbar-brand"
					style="color: #fff;"
					aria-expanded="false"
				>
					<img
						...
						{isLoading() ? (
							...
							<>
								...
								<ul class="dropdown-menu dropdown-menu-dark text-small shadow">
									...
									<li>
										<Link class="dropdown-item" href="/my-list/">
											My list
										</Link>
									</li>
									<li>
