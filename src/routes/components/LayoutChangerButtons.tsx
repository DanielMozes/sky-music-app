...
<div id="layoutButton" class="d-block d-sm-none m-2">
  <a id="layoutButtonLeft" class="d-none d-sm-block" onclick={() => changeLayout("right")}><BsFileEarmarkMusicFill /></a>
  <a id="layoutButtonRight" onclick={() => changeLayout("left")}><BsMusicPlayerFill /></a>
</div>
    );
}
