...
<div id="rightSection" class="bg-body-tertiary border rounded-3" style="background-color: #212529 !important;">
  ...
  <MusicStyleSelectionButtonGroup />
      ...
      <img src="/music.png" style="max-width:25px; max-height:125px; padding:0; margin-left: 5px;" />
        <div class="col">
          <div class="card">
      ...
      <img src="/playlist.png" style="max-width:25px; max-height:200px; padding:0; margin-left: 5px;" />
        <div class="col">
