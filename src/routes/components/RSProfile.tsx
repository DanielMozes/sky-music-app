  ...
  <div class="px-4 py-5 my-5 text-center">
    ...
    <div class="col-lg-6 mx-auto">
      ...
      <div class="list-group">
        <a href="/settings/" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
          <IoSettingsSharp />
        ...
        <a href="/my-list/" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
          <IoListSharp />
          <div class="d-flex gap-2 w-100 justify-content-between">
            <div>
        ...
        <a href="#" class="list-group-item list-group-item-action list-group-item-danger d-flex gap-3 py-3" aria-current="true">
          <TiDelete />
          <div class="d-flex gap-2 w-100 justify-content-between">
            <div>
